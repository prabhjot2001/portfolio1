  ...
  return (
    ...
    <header className='flex bg-white sticky top-0 left-0 w-full justify-between border-b-2 border-black z-10'>
      ...
      <div className='flex items-center sm:mr-5'>
        ...
        <AnimatePresence>
          {isOpen &&
            <motion.div variants={menuAnimation} initial="initial" animate="animate" exit="exit" className='fixed origin-top left-0 top-0 w-full h-screen bg-[#fcb65f] text-black p-4'>
              ...
              <div className='flex h-full flex-col'>
                ...
                >
                  {
                    links.map((item, i) => <div className='overflow-hidden'>
